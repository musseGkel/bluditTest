...
public class ChangeContentPositionTest {
    ...
    @Test
    public void testChangeContentPosition() {
        ...
        contentPage.clearPositionField();
        contentPage.enterPosition("30");
        contentPage.clickSave();
        contentPage.clickContentLink();
        contentPage.clickTestContentLink();
        contentPage.clickAdvancedButton();

        assertEquals("30", contentPage.getPositionValue());
