...
public class ChangeContentUrlTest {
    ...
    @Test
    public void testChangeContentUrl() {
        ...
        contentPage.clearFriendlyUrl();
        contentPage.enterFriendlyUrl("new-post-url");
        contentPage.clickSave();
        contentPage.clickContentLink();

        assertEquals("/new-post-url", contentPage.getFriendlyUrl("Test Content"));
